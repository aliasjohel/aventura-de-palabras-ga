(function (root, factory) {
  ...
  const words = [
    ...
    ["FUEGO","Produce luz y calor cuando algo arde."],
    ["LLAMA","Parte visible y luminosa de un fuego."],
    ["BRASA","Trozo de combustible que arde sin llama."],
    ["CHISPA","Partícula encendida que salta del fuego."],
    ["HUMO","Mezcla de gases y partículas que sale al quemar algo."],
    ["CARBON","Combustible negro que puede usarse en una forja."],
    ["LAVA","Roca fundida que sale de un volcán."],
    ["VOLCAN","Montaña por cuya abertura puede salir lava."],
    ["CRATER","Abertura en la parte superior de un volcán."],
    ["MAGMA","Roca fundida que se encuentra bajo la superficie terrestre."],
    ["OBSIDIANA","Roca volcánica negra de aspecto parecido al vidrio."],
    ["ROCA","Material sólido natural que forma parte del terreno."],
    ["GRIETA","Abertura estrecha en una roca o una pared."],
    ["CAVERNA","Cavidad grande y profunda bajo tierra."],
    ["TUNEL","Paso excavado que atraviesa una montaña o el subsuelo."],
    ["ANTORCHA","Palo con material combustible que ilumina al arder."],
    ["FAROL","Caja con luz dentro que ilumina el camino."],
    ["HIERRO","Metal usado para fabricar herramientas y armaduras."],
    ["ACERO","Aleación de hierro y carbono resistente y dura."],
    ["YUNQUE","Bloque de metal sobre el que trabaja un herrero."],
    ["MARTILLO","Herramienta que golpea el metal para darle forma."],
    ["ESCUDO","Objeto que se sostiene para protegerse de ataques."],
    ["ARMADURA","Conjunto de piezas que protege el cuerpo de un guerrero."],
    ["ESPADA","Arma de hoja larga con filo y empuñadura."],
    ["CADENA","Serie de eslabones enlazados entre sí."],
    ["LLAVE","Objeto que abre una cerradura."],
    ["PORTAL","Entrada que en la aventura conecta lugares lejanos."],
    ["TORRE","Construcción alta que sirve para vigilar."],
    ["MURALLA","Pared grande que protege una ciudad o fortaleza."],
    ["CASTILLO","Construcción fortificada con torres y murallas."],
    ["TRONO","Asiento ceremonial de quien gobierna un reino."],
    ["CORONA","Aro que se lleva en la cabeza como símbolo de realeza."],
    ["ESTANDARTE","Bandera que representa a un reino o a un grupo."],
    ["JURAMENTO","Promesa solemne de cumplir algo."],
    ["AMISTAD","Afecto y confianza entre personas que se aprecian."],
    ["CORAJE","Fuerza de ánimo para afrontar un peligro."],
    ["PERDON","Decisión de dejar atrás una ofensa."],
    ["VERDAD","Lo que coincide con los hechos y se opone a la mentira."],
    ["PAZ","Estado de tranquilidad y ausencia de guerra."],
    ["DESTINO","Lugar al que alguien se dirige en su viaje."],
