...
assert.match(html, /id="selectorModosJuego"[\s\S]+id="btnArcade"/);
assert.match(html, /id="pantallaArcade"/);
...
assert.match(html, /id="modalTutorialVersus"[\s\S]+id="btnComenzarTutorialVersus"[\s\S]+id="accionPasoTutorialVersus"/);
assert.doesNotMatch(html, /id="impactoTutorialVersus"|id="tecladoTutorialVersus"/);
...
assert.match(estilos, /\.tutorial-combate-real #pantallaVersus\.activa/);
...
assert.match(app, /hombre-lobo-humano\.png/);
assert.match(app, /hombre-lobo-transformacion\.png/);
assert.match(app, /function programarTransformacionEntradaHombreLobo\(/);
assert.match(app, /elemento\.src = srcHombreLoboHumanoVersus[\s\S]+elemento\.src = srcHombreLoboTransformacionVersus[\s\S]+elemento\.src = srcHombreLoboAullidoVersus/);
assert.match(estilos, /@keyframes auraTransformacionHombreLoboVersus/);
...
assert.match(estilos, /#pantallaMenu #btnJugar \{[\s\S]+rgba\(24, 151, 83, 0\.44\)[\s\S]+rgba\(6, 72, 52, 0\.2\)/);
assert.match(estilos, /#pantallaMenu \.btn-arcade-menu \{[\s\S]+rgba\(112, 73, 39, 0\.4\)[\s\S]+rgba\(63, 39, 25, 0\.17\)/);
assert.match(estilos, /#pantallaMenu \.btn-tutorial-versus-menu \{[\s\S]+rgba\(36, 75, 89, 0\.38\)[\s\S]+rgba\(20, 44, 55, 0\.16\)/);
assert.match(estilos, /#pantallaMenu #btnConfiguracion \{[\s\S]+rgba\(52, 91, 72, 0\.34\)[\s\S]+rgba\(19, 42, 35, 0\.15\)/);
...
assert.match(app, /dragon-hielo-aterrizaje-alto-v2\.png/);
assert.match(app, /dragon-hielo-aterrizaje-bajo-v2\.png/);
...
assert.match(app, /function actualizarBloqueoTroncoMision\(/);
assert.match(app, /tronco-antiguo-caido-bosque\.png/);
assert.match(estilos, /@keyframes caerArbolSobreSendero/);
assert.match(estilos, /\.capa-tronco-bloqueo\.tronco-activo \.tronco-bloqueo/);
assert.doesNotMatch(app, /rama-frondosa-bosque-\$\{variante\}\.png/);
